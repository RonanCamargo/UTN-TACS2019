...
public class PlacesRegisteredInTheSystemTest {
    ...
    public void initialize() {
        ...
        Place place5 = placeRepository.createPlace("place5");

        LocalDate today = LocalDate.of(2019, Month.APRIL, 19);

        place1.setRegistrationDate(today);
        place2.setRegistrationDate(LocalDate.of(2019, Month.APRIL, 17));
        place3.setRegistrationDate(LocalDate.of(2019, Month.APRIL, 13));
        place4.setRegistrationDate(LocalDate.of(2019, Month.MARCH, 30));
        place5.setRegistrationDate(LocalDate.of(2010, Month.MARCH, 30));
...
//    En el día de hoy
    ...
    public void knowTheTotalNumberOfPlacesRegisteredInTheSystemInTheLast3Days() {
        Assert.assertEquals(2, placeRepository.amountOfPlacesRegisteredInTheSystemInTheLast(3));
    }

    //    En la última semana
    @Test
    public void knowTheTotalNumberOfPlacesRegisteredInTheSystemInTheLastWeek() {
        Assert.assertEquals(3, placeRepository.amountOfPlacesRegisteredInTheSystemInTheLast(7));
    }

    //    En el último mes
    @Test
    public void knowTheTotalNumberOfPlacesRegisteredInTheSystemInTheLastMonth() {
        Assert.assertEquals(4, placeRepository.amountOfPlacesRegisteredInTheSystemInTheLast(30));
    }

    //    Desde el inicio de los tiempos
    @Test
    public void knowTheTotalNumberOfPlacesRegisteredInTheSystemInTheLastMonthSinceTheBeginningOfTime() {
        Assert.assertEquals(5, placeRepository.amountOfPlacesRegisteredInTheSystemInTheLast(Integer.MAX_VALUE));
