...
import utn.tacs.grupo3.model.Administrator;
...
public class AdministratorTest {
    ...
    public void initialize() {
        ...
        administrator.addUser(user1);
        administrator.addUser(user2);
    }
...
//    usuarios que se interesaron en el mismo (lo agregaron a una lista).
    ...
    public void seeTheAmountOfUsersInterestedInAPlace(){
        Assert.assertEquals(2,administrator.amountOfUsersInterestedIn(aPlace1));
    }
